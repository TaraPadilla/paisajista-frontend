...
export class CaracteristicaService extends BaseApiService {
  ...
  async create(caracteristica: Omit<Caracteristica, 'id' | 'createdAt' | 'updatedAt' | 'deletedAt' | 'tipo_dato' | 'tipo_campo'>): Promise<Caracteristica> {
    return this.post<Caracteristica>(this.endpoint, caracteristica);
  }

  async update(id: number, caracteristica: Partial<Omit<Caracteristica, 'id' | 'createdAt' | 'updatedAt' | 'deletedAt' | 'tipo_dato' | 'tipo_campo'>>): Promise<Caracteristica> {
